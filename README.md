...
- 🚀 **重大功能扩展**：二进制文件检测能力大幅提�?
- �?扩展二进制魔术数支持�?0种到70+种格�?
- 🖼�?新增图像格式支持：BMP, TIFF, WEBP, ICO, SVG�?
- 🎵 新增音频格式支持：MP3, WAV, FLAC, AAC, OGG�? 
- 🎬 新增视频格式支持：MP4, AVI, MKV, MOV, FLV�?
- 📦 新增压缩格式支持：RAR, 7Z, TAR, BZIP2�?
- 📄 新增文档格式支持：DOC, XLS, PPT, RTF�?
- 💾 新增数据库和执行文件格式支持
- 🔧 优化GitHub Actions发布流程，支持智能发布说明生�?
- 🛠�?新增自动化发布脚本（PowerShell版本�?
- 📝 完善项目文档和使用指�?
